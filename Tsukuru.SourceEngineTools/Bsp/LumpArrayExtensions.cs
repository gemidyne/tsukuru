...
using Tsukuru.SourceEngineTools.Bsp.LumpData;
using Tsukuru.SourceEngineTools.Bsp.LumpData.GameLumps;

namespace Tsukuru.SourceEngineTools.Bsp
{
	public static class LumpArrayExtensions
    {
        ...
        public static EntitiesString GetEntitiesString(this Lump[] lumps)
        {
	        return (lumps[(int)LumpType.Entities].Data as EntitiesString);
        }
